...
By default bamboo will do an anonymous shallow clone of the repo.  This will preserve neither the `git remote` information nor the list of tags.  If you are using bamboo to create commits you may want to use a code block similar to the following:
